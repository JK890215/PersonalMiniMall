...
public class OrderStartAction implements Action{
	...
	throws Exception{
		System.out.println("___ OrderStartAction.java");
		...
		System.out.println(order+"<-- order___ OrderStartAction.java");
		System.out.println(Integer.parseInt(request.getParameter("goodsnum"))+"<-- goodsnum OrderStartAction.java");
		System.out.println(Integer.parseInt(request.getParameter("amount"))+"<-- amount OrderStartAction.java");
		System.out.println(Integer.parseInt(request.getParameter("price"))+"<-- price OrderStartAction.java");
		System.out.println(request.getParameter("goodsname")+"<-- goodsname OrderStartAction.java");
		System.out.println(request.getParameter("size")+"<-- size OrderStartAction.java");
		System.out.println(request.getParameter("color")+"<-- color OrderStartAction.java");
