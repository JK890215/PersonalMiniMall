...
public class MemberFrontController extends HttpServlet{
	...
	throws IOException, ServletException{
		request.setCharacterEncoding("euc-kr");
		 ...
		 }else if(command.equals("/member/MemberOut.me")){
			 forward=new ActionForward();
			 forward.setPath("/member/member_out.jsp");
		 }else if(command.equals("/member/Zipcode.me")){
			 forward=new ActionForward();
		 ...
		 }else if(command.equals("/member/MemberModifyAction_1.me")){
		 ...
		 }else if(command.equals("/member/MemberModifyAction_2.me")){
		 ...
		 }else if(command.equals("/member/MemberFindAction.me")){
		 ...
		 }else if(command.equals("/member/MemberZipcodeAction.me")){
